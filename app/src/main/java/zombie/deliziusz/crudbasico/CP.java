...
public class CP extends ContentProvider {
    ...
    static {
        uriMatcher.addURI("zombie.deliziusz.crudbasico.provider", "contactos", 1);
        uriMatcher.addURI("zombie.deliziusz.crudbasico.provider", "contactos/#", 2);
        uriMatcher.addURI("zombie.deliziusz.crudbasico.provider", "contactos/*", 3);
    }
        ...
        switch (uriMatcher.match(uri)) {
            case 1:
                resul = "vnd.android.cursor.dir/vnd." +
                        "zombie.deliziusz.crudbasico.provider.contactos";
                break;
            case 2:
